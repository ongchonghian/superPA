...
export function FirebaseTroubleshootingGuide({ showRestartNote = true }: { showRestartNote?: boolean }) {
  return (
    <div className="mt-6 text-left text-foreground/90 space-y-4 text-sm">
        ...
        <p>
            <strong>1. Authorize Your App's Domain (for Published Apps):</strong><br/>
            ...
            <ul className="list-disc list-inside pl-4 mt-2 space-y-1">
                <li>Go to your Firebase Console &rarr; Build &rarr; Authentication &rarr; Settings tab.</li>
                <li>Under the "Authorized domains" section, click **Add domain**.</li>
                <li>Enter the domain of your deployed app (e.g., `your-app-name.web.app`) and click Add.</li>
            </ul>
        </p>

        <p>
            <strong>2. Check `.env.local` &amp; Project Settings:</strong><br/>
        ...
        <p>
            <strong>3. Check Authentication Methods:</strong><br/>
            In the Firebase Console, go to Build &rarr; Authentication &rarr; Sign-in method tab. Ensure **Google** sign-in is **Enabled**.
        </p>

        <p>
            <strong>4. Check Firestore (Database):</strong><br/>
        ...
        <p>
            <strong>5. Check Cloud Storage:</strong><br/>
